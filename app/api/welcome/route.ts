...
export async function POST(req: Request) {
  ...
  : selfAssessment === 'strong'
    ...
    const systemPrompt = [
      ...
      '5. Same logic applies to other Y1 courses: MAT237Y1 covers full year, never pair with a H1 equivalent. MAT257Y1 covers full year. MAT235Y1 covers full year. MAT351Y1 covers full year. MAT347Y1 covers full year. CHM151Y1 covers full year. ECO105Y1 covers full year. ECO200Y1/ECO202Y1/ECO204Y1/ECO206Y1/ECO208Y1/ECO209Y1/ECO220Y1 covers full year.',
      '6. CSC110Y1 and CSC111H1 are only provided to CS stream first-year students. CSC110Y1 is full year but it completes the full year contents in fall, so only provided in fall. No winter CSC110Y1. CSC111H1 is its Winter continuation — they are a pair, not alternatives.',
      '7. STA237H1, STA247H1 need MAT136H1 ALREADY COMPLETED and STA257H1 need MAT137Y1/MAT157Y1 ALREADY COMPLETED.',
      '8. TOTAL COURSES: 8-12 across both semesters. Never fewer than 6.',
      '9. MANDATORY BREADTH: At least 1-2 courses outside main department.',
      '10. For third+ year: generate 4 semesters. Total 12-20 courses.',
      '11. Third/Fourth year has NO fixed requirements. Only prereqs must be met.',
      '12. CSC207H1 IN FIRST YEAR RULE:',
      ...
      '',
      '14. CSC265H1 is a harder exclusion to CSC263H1',
    ...
    const firstYearTemplates = [
      ...
      'Winter: CSC111H1 + MAT137/157Y1(Y1) + MAT224/247H1 + (STA130H1/ECO102H1/PSY100H1/others)',
      'Total: 8~10 courses',
      '',
      'Out of CS but CS ambitious (short answer mentions challenge some math):',
      'Fall: MAT157Y1(Y1) + MAT240H1 + CSC148H1 + (ECO101H1/PHY131H1/PHY151H1/CHM131H1/others)',
      'Winter: MAT157Y1(Y1) + MAT247H1 + CSC165/240H1 + (STA130H1/ECO102H1/PHY131H1/others)',
      'Total: 8~10 courses. CSC207 NOT included — CSC148 prereq not done yet.',
      '',
      'Out of CS and CS very confident + math very confident + wants accelerate (explicit in short answer):',
      'Fall: MAT157Y1(Y1) + MAT240H1 + CSC148H1 + (STA130H1/ECO101H1/PHY131H1/PHY151H1/others)',
      'Winter: MAT157Y1(Y1) + MAT247H1 + (MAT344H1 if they want to get even harder) + CSC240H1 + (PHY132H1/PHY152H1/CSC207H1/ECO102H1/others)',
      'Total: 8~12. CSC207 allowed Winter because CSC148 was Fall.',
      '',
      'Out of CS and CS theory track + very confident (CSC Specialist + grad school + strong + mentions theory):',
      'Fall: MAT137/157Y1(Y1) + MAT223/240H1 + CSC148H1 + CSC240H1 + ECO101H1',
      'Winter: MAT137/157Y1(Y1) + MAT224/247H1 + CSC207H1 + STA130H1 + ECO102H1',
      'Total: 8~12. Note: CSC240H1 replaces CSC165H1 for theory track.',
      '',
      'Out of CS and CS minimal math (short answer says just need to pass math):',
      'Fall: MAT135H1 + CSC148H1 + ECO101H1 + SOC100H1',
      'Winter: MAT136H1 + MAT223H1 + CSC165H1 + ECO102H1',
      'Total: 8~9 courses. CSC207 ok Winter because CSC148 was Fall.',
      '',
      'Math Specialist:',
      'Fall: MAT157Y1(Y1) + MAT240H1 + CSC108H1 + (PHY131H1/PHY151H1)',
      'Winter: MAT157Y1(Y1) + MAT247H1 + CSC148H1 + STA130H1 + (PHY132H1/PSY152H1) + (CSC165H1) depending on their interests (or other breadth courses)',
      'Total: 8~10 courses.',
      '',
      'Math Major:',
      'Fall: MAT137Y1(Y1) + MAT223H1 + CSC108H1 + ECO101H1 + STA130H1',
      'Winter: MAT137Y1(Y1) + MAT224H1 + STA130H1 + CSC148H1 + ECO102H1',
      'Total: 8~10. STA237 cannot be used — MAT137 not yet completed.',
      '',
      'Stats/Data Science:',
      'Fall: MAT137Y1(Y1) + MAT223H1 + CSC108/148H1 + ECO101H1 + STA130H1',
      'Winter: MAT137Y1(Y1) + (CSC148H1) + CSC165H1 + ECO102H1 + PSY100H1',
      'Total: 8~10.',
      '',
      'Life Sciences:',
      ...
      'Fall: MAT157Y1(Y1) + PHY151H1 + MAT223H1 + CSC108/148H1 + (CHM151Y1(Y1)) + ECO101H1',
      'Winter: MAT157Y1(Y1) + PHY152H1 + MAT240H1 + (CSC148H1) + (CSC165/240H1) + (CHM151Y1(Y1)) + ECO102H1',
      'Total: 8~12.',
      '',
      'Economics/Commerce:',
      'Fall: MAT133Y1(Y1) + ECO101H1 + PSY100H1 + RSM100H1 + others (or no)',
      'Winter: MAT133Y1(Y1) + ECO102H1 + RSM219H1 + others (or no)',
      'Total: 6~9.',
    ].join('\n')
    ...
    const secondYearTemplates = [
      ...
      'Fall: CSC207H1 + CSC236H1 + CSC236H1 + MAT237Y1(Y1)',
      'Winter: CSC258H1 + CSC209H1 + CSC263/265H1 + MAT223H1 + STA237H1 — WAIT STA237 needs MAT137 completed',
      ...
      'Total: 8-9 courses.',
      '',
      'CS ambitious (very very strong in math + grad school + has MAT157):',
      'Fall: CSC207H1 + CSC236H1 + MAT257Y1(Y1)',
      'Winter: CSC258H1 + MAT257Y1(Y1) + CSC263/265H1 — prereq CSC207+CSC236 needed, CSC236 done Fall',
      ...
      'Fall: MAT257Y1(Y1) + STA257H1 + (MAT327H1/MAT344H1/MAT347Y1(Y1)/CSC207H1/CSC236H1/CSC336H1/others)',
      'Winter: MAT257Y1(Y1) + MAT267H1 + (MAT347Y1(Y1)/MAT315H1/STA261H1/CSC263H1/CSC265H1/others)',
      'If very strong (selfAssessment=strong): also add MAT267H1 in Winter',
      'Total: 8-9.',
      '',
      'Math Major (has MAT137):',
      'Fall: MAT235/237Y1(Y1) + MAT244/246H1 + (others)',
      'Winter: MAT235/237Y1(Y1) + MAT244/246H1 + (others)',
      'Total: 8.',
      '',
      'Stats (has MAT137):',
      ...
      'Winter: MAT237Y1(Y1) + STA238H1 + CSC165H1 + ECO102H1',
      'Total: 8.',
    ].join('\n')
